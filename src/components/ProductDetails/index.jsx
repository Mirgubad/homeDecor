...
const ProductDetails = ({ title, description, id, price, currency }) => {
  ...
  return (
    <div className={styles["details"]}>
      ...
      <div className={styles["colors__container"]}>
        {colors?.length > 0 && (
          <Colors setColorId={setColorId} colors={colors} title={true} />
        )}
      </div>
      ...
      <div className={styles["action__buttons"]}>
        <div onClick={handleAddToCart} style={{ width: "50%" }}>
          {isLoading ? (
            <Loader />
          ) : (
            <ButtonPrimary>
